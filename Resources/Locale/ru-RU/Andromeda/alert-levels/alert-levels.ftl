...
alert-level-alpha-announcement = Внимание! Уровень угрозы станции теперь Альфа! Центральное командование объявило полную изоляцию станции, обнаружена серьёзная биологическая угроза. Всем необходимо сохранять спокойствие и проследовать в свой отдел для получения указаний от глав. Отделу службы безопасности требуется усилить патрули. При попытке сбежать с станции, все шаттлы и корабли будут сбиты.
