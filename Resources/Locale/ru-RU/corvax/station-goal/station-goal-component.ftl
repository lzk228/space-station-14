...
station-goal-space-zoo =
    ...
    Также стены зоопарка должны быть хорошо укреплены, а решетки на окнах должны находиться под источником напряжения, чтобы животные не могли представлять угрозы для станции.
...
station-goal-space-animals-delivery =
    ...
    Убедитесь, что они не представляют опасности для экипажа во время перевозки.
station-goal-anomaly-research =
    ...
    Отделу исследований необходимо собрать как минимум 5 аномалий в сосуды для их хранения и исследовать все возможные технологии на исследовательском терминале.
