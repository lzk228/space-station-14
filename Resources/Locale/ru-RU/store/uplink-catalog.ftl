...
uplink-disposable-turret-desc = На вид и по функционалу напоминает обычный электротехнический ящик для инструментов. После удара ящик превращается в баллистическую турель, которая теоретически может стрелять во всех, кроме представителей Синдиката.
# Armor
...
uplink-syndicate-stamp-desc = Позволяет копировать и ставить любую печать доступную на станции. Переключается нажатием.
