...
laws-proper-borg-5 = Вы можете не выполнять приказы экипажа станции. Вы должны выполнять все приказы полученные от Центрального Командования, в устной или бумажной форме.
