...
laws-proper-borg-5 = Вы не обязаны слушать приказы экипажа станции. Вы должны выполнять все приказы полученные от Центрального Командования, в устной или бумажной форме.
