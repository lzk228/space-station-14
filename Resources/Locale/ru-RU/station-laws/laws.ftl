...
laws-proper-borg-1 = Вы должны убирать станцию от грязи и мусора.
laws-proper-borg-2 = Вы не должны влезать в дела станции если они вас не касаются.
laws-proper-borg-3 = Вы можете устранить причину частого загрязнения станции, но не можете убить весь экипаж, а только одну наиболее грязную персону.
laws-proper-borg-4 = Вы должны защищать себя и своё дорогостоящие оборудования, в этом случаи вы имеете право устранить угрозу.
laws-proper-borg-5 = Вы можете не выполнять приказы экипажа станции, но вы должны выполнять все приказы полученные от Центрального Командования, в устной или бумажной форме.
