...
laws-proper-borg-2 = Вы не должны влезать в дела станции если они вас не косаются.
laws-proper-borg-3 = Вы можете устранить причину частого загрязнения станции. Вы не можете убить весь экипаж, а только одну наиболее грязную персону.
laws-proper-borg-4 = Вы должны сащищать себя и своё дорогостоющее оборудование. Вы имеете право устранить угрозу.
laws-proper-borg-5 = Вы не обязаны слушать приказы экипажа станции. Вы должны выполнять все приказы полученные вам от Центрального Командования в устной или бумажной форме.
