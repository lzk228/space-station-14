...
ent-ClothingNeckCloakSec = плащ порядочного сотрудника безопасности
    .desc = Этот плащ был сшит по специальному заказу НаноТрейзен, для порядочных сотрудников. Он такой же красный, как и кровь, чтобы никто не знал, сколько вы старались, ради премии.
ent-ClothingNeckCloakBarmen = плащ бармена
    .desc = Ходят слухи, что этот плащ носили только лучшие бармены! Но вы в этом не уверенны.
